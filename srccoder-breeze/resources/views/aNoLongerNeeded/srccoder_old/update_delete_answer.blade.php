{{--  Delete the question --}}
{{--  There are answer associated with this question, so we can't delete it --}}
{{--  Check if there are any answer associated with this question --}}
...
if (isset($_POST['delete'])) {
    ...
    if ($result->num_rows > 0) {
                echo "You can't delete a question that has answer. Please delete the answer first.";
    } else {
