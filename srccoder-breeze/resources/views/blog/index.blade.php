    ...
    <div class="container text-red-700">
        <div class="row">
            <div class="pt-2 col-12">
                 <div class="row">
                    <div class="col-8">
                        <h1 class="mt-4 display-one">Srccoder-Pedia!</h1>
                        <p>Enjoy reading our wikis. Click on a post to read! Familiar with Srccder, add your own wiki.</p>
                    </div>
                    <div class="col-4">
                        @if(Auth::User())
                        <p>Create new wiki</p>
