...
<div class="bg-gradient-to-br from-gray-900 to-black">
    <div class="container p-8 mx-auto overflow-hidden text-gray-300 md:rounded-lg md:p-10 lg:p-12">
        ...
        <p class="max-w-5xl font-sans text-4xl font-bold text-gray-200 lg:text-7xl lg:pr-24 md:text-6xl">
